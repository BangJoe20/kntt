...
ulang:
// function change(){
echo color("green","                    KARYAWAN TUHAN\n");
echo color("white","           Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("green","                ONLY GOD CAN JUDGE ME         \n");
echo color("white","                  Format Kode 62*** \n");
        $nama = nama();
        $email = str_replace(" ", "", $nama) . mt_rand(100, 999);
        echo color("green"," NOMORE COK  : ");
        // $no = trim(fgets(STDIN));
	...
	gocar:
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green"," Message: ".$message);
        echo "\n".color("green","BONUS UNTUK SI BOOSS.");
        echo "\n".color("white"," Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(3);
